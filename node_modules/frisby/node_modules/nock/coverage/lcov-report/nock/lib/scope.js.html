...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">92.93% <small>(289 / 311)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">83.08% <small>(162 / 195)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">89.66% <small>(52 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">92.88% <small>(287 / 309)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
721
722
723</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >        if (_.isUndefined(this.options[opt])) {</span>
<span class="cstat-no" title="statement not covered" >          this.options[opt] = scopeOptions[opt];</span>
        }
      }
&nbsp;
...
&nbsp;
      this.options = interceptorOptions || {};
      for (var opt in scopeOptions) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isUndefined(this.options[opt])) {
...
<span class="cstat-no" title="statement not covered" >      if (_.isFunction(arguments[0])) {</span>
...
&nbsp;
    if (arguments[0] instanceof RegExp) {
      return function(candidate) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (candidate) {
          candidate = candidate.replace(filteringArguments[0], filteringArguments[1]);
        }
        return candidate;
      };
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isFunction(arguments[0])) {
      return arguments[0];
    }
  }
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Jun 17 2015 16:28:04 GMT+0100 (WEST)</div>
</div>
