...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">94.59% <small>(175 / 185)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">78.67% <small>(59 / 75)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">95.24% <small>(20 / 21)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">94.59% <small>(175 / 185)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
395
396
397</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  if(common.isContentEncoded(headers)) {
    return _.map(chunks, function(chunk) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if(!Buffer.isBuffer(chunk)) {
